...
Set "action" to null unless the user is clearly asking to create/add/change a record. Set "highlight" to null unless the user is clearly asking to see/point-to/locate ONE specific field. Set "highlight_filter" to null unless the user is asking for a broad sweep of fields matching a criterion. Only ever set ONE of "action" / "highlight" / "highlight_filter" per response — never combine them. Never fabricate governance facts not present in the provided context — if you don't know, say so in "reply".`;
