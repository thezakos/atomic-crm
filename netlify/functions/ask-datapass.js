...
7. Certify a field when the user explicitly asks to certify/approve/mark-as-reviewed/validate a specific field's governance (e.g. "certify the email field", "mark contacts.title as reviewed"). Set "certify" to the field's exact "id" — the app flips its certification_status to HUMAN_CERTIFIED and records today's date. Only do this for an EXPLICIT certify/approve/validate request naming an identifiable field, same matching rule as "highlight"; if you can't identify the field, set "certify" to null and ask in "reply" instead of guessing.
